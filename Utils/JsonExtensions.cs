...
public static class JsonExtensions
{
    ...
    /// <returns>
    /// The first item, if the <paramref name="element"/> is an array and is not empty, or <see
    ...
    /// <returns>
    /// The property specified as above, or <see langword="null"/> if no such property is found.
    /// </returns>
